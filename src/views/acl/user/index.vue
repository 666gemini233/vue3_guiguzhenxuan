<template>
  ...
  <el-drawer v-model="drawer">
    ...
    <template #footer>
      <div style="display: flex:auto;">
        <el-button @click="cancel" type="default" size="default">
          取消
        </el-button>
  ...
  <el-drawer v-model="drawer1">
    ...
    <template #footer>
      <div style="display: flex:auto;">
        <el-button @click="drawer1 = false" type="default" size="default">
          取消
        </el-button>
        <el-button @click="confirmClick" type="primary" size="default">
          确定
        </el-button>
      </div>
    </template>
